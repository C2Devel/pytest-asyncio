...
%if %{with tests}
BuildRequires:  python%{python3_pkgversion}-pytest >= 3.0.7
BuildRequires:  python%{python3_pkgversion}-coverage
BuildRequires:  python%{python3_pkgversion}-async-generator >= 1.3
BuildRequires:  python%{python3_pkgversion}-hypothesis >= 3.64
%endif
Requires:       python%{python3_pkgversion}-pytest >= 3.0.7
Provides:       python36-%{pypi_name}
...
%changelog
* Wed Dec 16 2020 Andrey Kulaev <adkulaev@gmail.com> - 0.9.0-2 - CROC2
- Remake spec for C2DEVEL
